const blogPosts = [
  {
    ...
    tags: ['Freelance', 'Web', 'Mobile', 'AI Agents', 'Security'],
    excerpt:
      "Alongside my studies and internships, I take on freelance work for small and medium businesses, building whatever they actually need, from a landing page to a full AI agent or a security review.",
    content: [
      {
        type: 'p',
        text: "Outside of my full-time studies and internships, I run a small part-time freelance practice. Most of my clients are small or medium businesses that need a solution, not a specific technology, so the work spans websites, mobile apps, AI agents, and, for a few clients, SOC analysis and security engineering, depending on what the problem actually calls for.",
      },
      {
        type: 'h2',
      ...
      },
      {
        ...
        items: [
          ...
          'SOC analysis & security engineering: monitoring, threat detection, and hardening work for a handful of clients who want an extra set of eyes on their security posture.',
        ],
      },
      {
        type: 'h2',
